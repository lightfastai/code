import type {
  ChatArtifactAttachment as ContractChatArtifactAttachment,
...
export type ChatArtifactAttachment = ContractChatArtifactAttachment;
export type ChatAttachment = ChatImageAttachment | ChatArtifactAttachment;
